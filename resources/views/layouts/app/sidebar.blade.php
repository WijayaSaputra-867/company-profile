        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group :heading="__('Content Management')" class="grid">
                    ...
                    <flux:sidebar.item icon="wrench-screwdriver" :href="route('admin.services.index')" :current="request()->routeIs('admin.services.*')" wire:navigate>
                        {{ __('Services') }}
                    </flux:sidebar.item>
                    <flux:sidebar.item icon="briefcase" :href="route('admin.portfolios.index')" :current="request()->routeIs('admin.portfolios.*')" wire:navigate>
                        {{ __('Portfolios') }}
                    </flux:sidebar.item>
