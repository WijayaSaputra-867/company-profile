@php
    $stats = [
        ['label' => 'Total Halaman', 'count' => \App\Models\Page::count(), 'icon' => 'document-text', 'color' => 'text-blue-600', 'bg' => 'bg-blue-500/10', 'route' => 'admin.pages.index'],
        ['label' => 'Total Layanan', 'count' => \App\Models\Service::count(), 'icon' => 'wrench-screwdriver', 'color' => 'text-indigo-600', 'bg' => 'bg-indigo-500/10', 'route' => 'admin.services.index'],
        ['label' => 'Total Portfolio', 'count' => \App\Models\Portfolio::count(), 'icon' => 'briefcase', 'color' => 'text-purple-600', 'bg' => 'bg-purple-500/10', 'route' => 'admin.portfolios.index'],
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 flex-1">
            ...
            <flux:card class="p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <flux:button :href="route('admin.portfolios.create')" icon="plus" variant="filled" class="justify-start">Portfolio Baru</flux:button>
                    <flux:button href="/" target="_blank" icon="eye" variant="filled" class="justify-start">Lihat Website</flux:button>
                </div>
            </flux:card>
